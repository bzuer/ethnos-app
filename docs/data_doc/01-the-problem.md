...
Every database like this one begins with a question: _where do you get the data?_
...
For anthropology there is nothing of the kind. **Not a partial one, not a paid one, not a national one.** There is no register that can be asked _"list the scholarly literature of anthropology"_ and answer usefully.
...
A concrete case. A large index reports that an edited volume has fourteen _authors_. A publisher's record reports two _editors_ and twelve chapter authors. The second is believed — not because the publisher is more virtuous, but because it was in a position to know, and the index was working from a format with no slot for the distinction.
